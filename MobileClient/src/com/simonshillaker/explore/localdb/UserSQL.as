package com.simonshillaker.explore.localdb
{
	public class UserSQL
	{
		...
		internal static const CREATE_USER_TABLE_SQL:String = "create table if not exists user " +
		...
		internal static const CREATE_USER_SQL:String =  "insert into user (username, name) values(?, ?)"; 
